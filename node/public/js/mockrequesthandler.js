...
function getForm(token, applicationID){
...
// USED FOR DEMO:
function retrieveAllApplicationsForPI(token, username){
...
// USED FOR DEMO:
function saveForm(token, formID, form){
	if (formID == 12345){
		var JSONvar = {status:true, ErrMsg:undefined, value:true};
	}
	else{
...
// USED FOR DEMO:
function changeApplicationStatus(token, applicationID, newStatus){
	if (applicationID = 12345)
		var JSONvar = {status:true, ErrMsg:undefined, value:true};
	else
		var JSONvar = {status:false, ErrMsg:Generic error, invalid applicationID, value:true};
...
// USED FOR DEMO:
function submitApplication(token, applicationID){
	if (applicationID == 12345){
		var JSONvar = {status:true, ErrMsg:undefined, value:true};
	}
	else{
